...
def get_conversational_chain(model_name,vectorstore=None,api_key=None):
    if model_name=="Google AI":
        prompt_template = """
        Answer the question as detail as posssible from the provided context. Make sure to provide all the details with proper structure.
        If answer is not found in the context. Say answer is not available in the document,don't provide wrong answer\n\n
        context:\n {context}\n
        question:\n {question}\n
        Answer:
        """
...
def user_input(user_question,model_name,api_key,pdf_docs,conversation_history):
    if api_key is None or pdf_docs is None:
        st.warning("Please provide API key and upload PDF documents to proceed.")
        return
    text_chunks = get_text_chunks(get_pdf_text(pdf_docs),model_name)
    vectorestore = get_vector_store(text_chunks,model_name,api_key)
...
def main():
    ...
    linkedin_profile_link = "https://www.linkedin.com/in/saiharini/"
